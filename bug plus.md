نمونه کد پایه برای اسکن باگ‌های رایج (XSS، SQLi، افشای اطلاعات حساس) این اسکریپت ساده، یک وب‌سایت را کراول می‌کند و روی هر URL تست XSS، SQLi و جستجوی اطلاعات حساس انجام می‌دهد
